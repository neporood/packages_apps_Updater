...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.crooked.base.version";
    public static final String PROP_DEVICE = "ro.crooked.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.crooked.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "crooked.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "crooked.updater.uri";
